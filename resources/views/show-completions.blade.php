...
{{--                </div>--}}
        ...
        <div class="rounded-2xl bg-white/5 ring-1 ring-white/10 backdrop-blur">
            ...
            <div class="space-y-3 px-4 py-4">
                ...
                @foreach($messages as $message)
                    <div class="rounded-2xl bg-black/30 ring-1 ring-white/10">
                        <div class="flex items-center justify-between px-4 py-3">
                    <span
                        @class([
                            'inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ring-1',
                            'bg-indigo-400/10 text-indigo-200 ring-indigo-400/20' => $message['role'] === 'system',
                            'bg-sky-400/10 text-sky-200 ring-sky-400/20' => $message['role'] === 'user',
                            'bg-emerald-400/10 text-emerald-200 ring-emerald-400/20' => $message['role'] === 'assistant',
                        ])>
                        {{ $message['role'] }}
                    </span>
