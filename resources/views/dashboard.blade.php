            ...
            <div class="p-5">
                ...
                @foreach($requests as $request)
                    <a href="{{ route('ai-monitor.show', ['id' => $request->id]) }}">
                        <div class="mt-2 cursor-pointer rounded-xl bg-black/30 ring-1 ring-white/10 backdrop-blur transition hover:bg-white/10 hover:ring-white/20">
                            <div class="grid grid-cols-12 gap-4 px-4 py-4 items-center text-sm text-white/90">

                                <div class="col-span-2">
                                <span class="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-xs font-semibold ring-1 ring-white/10">
                                    {{ $request->provider }}
                                </span>
                                </div>
                                ...
                                <span class="inline-flex items-center gap-1 rounded-full bg-emerald-400/10 px-2 py-1 text-xs font-semibold text-emerald-300 ring-1 ring-emerald-400/20">
                                    Success
                                </span>
                                </div>
                            </div>
